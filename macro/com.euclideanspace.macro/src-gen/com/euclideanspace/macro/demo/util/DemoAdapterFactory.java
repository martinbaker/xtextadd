/**
 */
package com.euclideanspace.macro.demo.util;
...
public class DemoAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DemoSwitch<Adapter> modelSwitch =
    new DemoSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseRecurse(Recurse object)
      {
        return createRecurseAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.euclideanspace.macro.demo.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.euclideanspace.macro.demo.Recurse <em>Recurse</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createRecurseAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link com.euclideanspace.macro.demo.MacroDef <em>Macro Def</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
