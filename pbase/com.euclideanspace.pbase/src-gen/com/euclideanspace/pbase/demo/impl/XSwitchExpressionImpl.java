 ...
 * <ul>
 *   <li>{@link com.euclideanspace.pbase.demo.impl.XSwitchExpressionImpl#getDeclaredParam <em>Declared Param</em>}</li>
 *   <li>{@link com.euclideanspace.pbase.demo.impl.XSwitchExpressionImpl#getSwitch <em>Switch</em>}</li>
 *   <li>{@link com.euclideanspace.pbase.demo.impl.XSwitchExpressionImpl#getCases <em>Cases</em>}</li>
 *   <li>{@link com.euclideanspace.pbase.demo.impl.XSwitchExpressionImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XSwitchExpressionImpl extends XExpressionImpl implements XSwitchExpression
{
  ...
  {
    return DemoPackage.Literals.XSWITCH_EXPRESSION;
  }
  ...
  public void setDeclaredParam(String newDeclaredParam)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.XSWITCH_EXPRESSION__DECLARED_PARAM, oldDeclaredParam, declaredParam));
  }
  ...
  public NotificationChain basicSetSwitch(XExpression newSwitch, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DemoPackage.XSWITCH_EXPRESSION__SWITCH, oldSwitch, newSwitch);
  ...
  public void setSwitch(XExpression newSwitch)
  {
    if (newSwitch != switch_)
    {
      ...
      if (switch_ != null)
        msgs = ((InternalEObject)switch_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DemoPackage.XSWITCH_EXPRESSION__SWITCH, null, msgs);
      if (newSwitch != null)
        msgs = ((InternalEObject)newSwitch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DemoPackage.XSWITCH_EXPRESSION__SWITCH, null, msgs);
      msgs = basicSetSwitch(newSwitch, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.XSWITCH_EXPRESSION__SWITCH, newSwitch, newSwitch));
  }
  ...
  public EList<XCasePart> getCases()
  {
    if (cases == null)
    {
      cases = new EObjectContainmentEList<XCasePart>(XCasePart.class, this, DemoPackage.XSWITCH_EXPRESSION__CASES);
    }
    return cases;
  }
  ...
  public NotificationChain basicSetDefault(XExpression newDefault, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DemoPackage.XSWITCH_EXPRESSION__DEFAULT, oldDefault, newDefault);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDefault(XExpression newDefault)
  {
    if (newDefault != default_)
    {
      NotificationChain msgs = null;
      if (default_ != null)
        msgs = ((InternalEObject)default_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DemoPackage.XSWITCH_EXPRESSION__DEFAULT, null, msgs);
      if (newDefault != null)
        msgs = ((InternalEObject)newDefault).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DemoPackage.XSWITCH_EXPRESSION__DEFAULT, null, msgs);
      msgs = basicSetDefault(newDefault, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.XSWITCH_EXPRESSION__DEFAULT, newDefault, newDefault));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DemoPackage.XSWITCH_EXPRESSION__SWITCH:
        return basicSetSwitch(null, msgs);
      case DemoPackage.XSWITCH_EXPRESSION__CASES:
        return ((InternalEList<?>)getCases()).basicRemove(otherEnd, msgs);
      case DemoPackage.XSWITCH_EXPRESSION__DEFAULT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DemoPackage.XSWITCH_EXPRESSION__DECLARED_PARAM:
