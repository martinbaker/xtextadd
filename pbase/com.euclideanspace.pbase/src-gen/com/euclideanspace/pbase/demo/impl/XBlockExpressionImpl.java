 ...
 * <ul>
 *   <li>{@link com.euclideanspace.pbase.demo.impl.XBlockExpressionImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XBlockExpressionImpl extends XExpressionImpl implements XBlockExpression
{
  ...
  {
    return DemoPackage.Literals.XBLOCK_EXPRESSION;
  }
  ...
  public EList<XExpression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<XExpression>(XExpression.class, this, DemoPackage.XBLOCK_EXPRESSION__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DemoPackage.XBLOCK_EXPRESSION__EXPRESSIONS:
