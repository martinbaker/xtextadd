		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrecidenceAccess().getGroup_0(), "rule__Precidence__Group_0__0");
					put(grammarAccess.getPrecidenceAccess().getGroup_1(), "rule__Precidence__Group_1__0");
					put(grammarAccess.getPrecidenceAccess().getGroup_2(), "rule__Precidence__Group_2__0");
					put(grammarAccess.getPrecidenceAccess().getGroup_3(), "rule__Precidence__Group_3__0");
					put(grammarAccess.getPrecidenceAccess().getGroup_4(), "rule__Precidence__Group_4__0");
					...
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_0_1(), "rule__Precidence__RuleAssignment_0_1");
					put(grammarAccess.getPrecidenceAccess().getPrefixAssignment_0_2(), "rule__Precidence__PrefixAssignment_0_2");
					put(grammarAccess.getPrecidenceAccess().getPar1Assignment_0_3(), "rule__Precidence__Par1Assignment_0_3");
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_1_1(), "rule__Precidence__RuleAssignment_1_1");
					put(grammarAccess.getPrecidenceAccess().getPar1Assignment_1_2(), "rule__Precidence__Par1Assignment_1_2");
					put(grammarAccess.getPrecidenceAccess().getSuffixAssignment_1_3(), "rule__Precidence__SuffixAssignment_1_3");
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_2_1(), "rule__Precidence__RuleAssignment_2_1");
					put(grammarAccess.getPrecidenceAccess().getPar1Assignment_2_2(), "rule__Precidence__Par1Assignment_2_2");
					put(grammarAccess.getPrecidenceAccess().getInfixAssignment_2_3(), "rule__Precidence__InfixAssignment_2_3");
					put(grammarAccess.getPrecidenceAccess().getPar2Assignment_2_4(), "rule__Precidence__Par2Assignment_2_4");
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_3_1(), "rule__Precidence__RuleAssignment_3_1");
					put(grammarAccess.getPrecidenceAccess().getPar1Assignment_3_2(), "rule__Precidence__Par1Assignment_3_2");
					put(grammarAccess.getPrecidenceAccess().getInfixleftAssignment_3_3(), "rule__Precidence__InfixleftAssignment_3_3");
					put(grammarAccess.getPrecidenceAccess().getPar2Assignment_3_4(), "rule__Precidence__Par2Assignment_3_4");
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_4_1(), "rule__Precidence__RuleAssignment_4_1");
					put(grammarAccess.getPrecidenceAccess().getLiteralAssignment_4_2(), "rule__Precidence__LiteralAssignment_4_2");
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_5_1(), "rule__Precidence__RuleAssignment_5_1");
					put(grammarAccess.getPrecidenceAccess().getBracketAssignment_5_2(), "rule__Precidence__BracketAssignment_5_2");
					put(grammarAccess.getPrecidenceAccess().getRuleAssignment_6_1(), "rule__Precidence__RuleAssignment_6_1");
